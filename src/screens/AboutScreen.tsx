...
export function AboutScreen() {
  ...
  const steps = [
    { emoji: '🎭', title: tr('step1Title'), text: tr('step1Text') },
    { emoji: '❓', title: tr('step2Title'), text: tr('step2Text') },
    { emoji: '👆', title: tr('step3Title'), text: tr('step3Text') },
    { emoji: '👑', title: tr('step4Title'), text: tr('step4Text') },
    { emoji: '🏆', title: tr('step5Title'), text: tr('step5Text') },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] flex flex-col px-6 pt-8 pb-12">
      ...
      {/* How to play */}
      <p className="text-white font-black text-lg mb-4">{tr('howToPlay')}</p>
      ...
      <div className="bg-[#FFE500]/5 border border-[#FFE500]/20 rounded-2xl p-5 mb-10">
        <p className="text-[#FFE500] font-bold text-sm mb-2">💡 {tr('goodToKnow')}</p>
