...
export function SuggestScreen() {
  ...
  if (done) {
    return (
      <div className="min-h-dvh bg-[#0F0F0F] flex flex-col items-center justify-center px-6 gap-5 text-center">
        ...
        <button onClick={() => navigate('/')} className="text-gray-400 text-sm">← {tr('back')}</button>
      </div>
    )
  }
